...
const Manage = React.lazy(() => import('./views/Manages/manage'));
const progress =React.lazy(() => import('./views/progresss/progress'));
const Add = React.lazy(() => import('./views/adds/add'));
const Resume = React.lazy(() => import('./views/resumes/resume'));
